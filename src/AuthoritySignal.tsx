/**
 * AuthoritySignal — [0:40-1:05]
 * Coined term card. The invisible message your frame sends.
 */
...
export const AuthoritySignal: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  const easeOut = (t: number) => 1 - Math.pow(1 - t, 3);

  // ── "AUTHORITY" slides down ───────────────────────────────────────────────
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            The invisible message your frame sends
          </span>
        </div>
