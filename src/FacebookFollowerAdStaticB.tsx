...
// Static 1080 × 1080 (1:1) — high-contrast sub-copy variant
// Sub-copy uses COLOR.textPrimary instead of textMuted for better legibility
// Render with: npm run render:png:fb-follower-b

export const FacebookFollowerAdStaticB: React.FC = () => {
  return (
    <AbsoluteFill
      style={{
