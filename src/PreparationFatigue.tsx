/**
 * PreparationFatigue — [0:00-0:15]
 * Coined term card. The trap that kills creative energy before filming.
 */
...
export const PreparationFatigue: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();

  const easeOut = (t: number) => 1 - Math.pow(1 - t, 3);

  // ── "PREPARATION" slides down ─────────────────────────────────────────────
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            The trap that kills your creative energy before you hit record
          </span>
        </div>
