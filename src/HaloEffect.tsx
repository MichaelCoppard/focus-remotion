/**
 * HaloEffect — [0:40-1:05]
 * Coined term card. Visual order signals perceived competence.
 */
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            Visual order signals perceived competence
          </span>
        </div>
        ...
        <div style={{
          ...
          <span style={{
            ...
            The yes happens before you speak.
          </span>
        </div>
