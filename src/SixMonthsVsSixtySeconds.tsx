/**
 * SixMonthsVsSixtySeconds — [0:15-0:40]
 * "6 MONTHS" struck through → "60 SECONDS" in gold.
 * Label: "YOUR FIRST VIDEO IS A TECHNICAL TEST"
 */
...
export const SixMonthsVsSixtySeconds: React.FC = () => {
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ opacity: labelOp, marginTop: 10 }}>
          <span style={{
            ...
            YOUR FIRST VIDEO IS A TECHNICAL TEST
          </span>
        </div>
